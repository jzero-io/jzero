...
func NewCobraMCPServer(rootCmd *cobra.Command) *CobraMCPServer {
	s := &CobraMCPServer{
		rootCmd: rootCmd,
...
func (s *CobraMCPServer) ServeStdio() error {
	return server.ServeStdio(s.server)
}

func (s *CobraMCPServer) handleToolCall(cmd *cobra.Command) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
