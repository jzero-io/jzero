...
func init() {
	...
	genCmd.Flags().StringSliceVarP(&gen.ModelIgnoreColumns, "model-ignore-columns", "", []string{"create_at", "created_at", "create_time", "update_at", "updated_at", "update_time"}, "ignore columns of model")
