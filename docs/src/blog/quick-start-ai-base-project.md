...
jzero new myproject --template https://github.com/your-org/jzero-template
```

### Creating Enterprise Templates

1. **Create based on default template**:
...
jzero new service-b --template https://github.com/your-org/jzero-template
```
...
└── README.md               # Enterprise development standards documentation
```
